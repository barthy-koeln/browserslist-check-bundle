 ...
 */
class getConsole_SuggestMissingPackageSubscriberService extends Tests_AppKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 5).'/vendor/symfony/framework-bundle/EventListener/SuggestMissingPackageSubscriber.php';
